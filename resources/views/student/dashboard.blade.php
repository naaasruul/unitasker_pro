   ...
   <div id="app">
       ...
       <div id="main">
           ...
           @else
           <div class="alert alert-danger alert-dismissible fade show" role="alert">
            The group with the provided unique code does not exist.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
           @endif
                               ...
                               <div class="card">
                                   <div class="card-body py-4 px-5">
                                       <div class="d-flex align-items-center">
                                           ...
                                           <div class="ms-3 name">
                                               <h5 class="font-bold">Amir Ahnaf</h5>
                               ...
                               <div class="card">
                                   <div class="card-body px-3 py-4-5">
                                       <div class="row">
                                           ...
                                           <div class="col-md-8">
                                               <h6 class="text-muted font-semibold">Subject 001</h6>
                                               <h6 class="font-extrabold mb-0">32 Members</h6>
                                           </div>
                                       </div>
                                   </div>
                               </div>
                               ...
                               <main class="calendar-contain">
                                   <aside class="calendar__sidebar">
                                       <div class="sidebar__nav">
                                           <!-- Icons by Icons8 -->
                                           <span class="sidebar__nav-item"><img class="icon icons8-Plus-Math"
                                           ...
                                           <span class="sidebar__nav-item"><img class="icon icons8-Share" width="22px"
                                                   height="22px"
                                           ...
                                           <span class="sidebar__nav-item"><img class="icon icons8-Up" width="22px"
                                                   height="22px"
                                           ...
                                           <span class="sidebar__nav-item"><img class="icon icons8-Down" width="22px"
                                                   height="22px"
                                       ...
                                       <ul class="sidebar__list">
                                           <li class="sidebar__list-item sidebar__list-item--complete"><span
                                                   class="list-item__time">8.30</span> Team Meeting</li>
                                           <li class="sidebar__list-item sidebar__list-item--complete"><span
                                                   class="list-item__time">10.00</span> Lunch with Sasha</li>
                                           <li class="sidebar__list-item"><span class="list-item__time">2.30</span>
                                               Design Review</li>
                                           <li class="sidebar__list-item"><span class="list-item__time">4.00</span>
                                               Get Groceries</li>
                                       </ul>
                                   </aside>
